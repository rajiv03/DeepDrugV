...
def myargs():
    ...
    parser.add_argument('--output', required = True, help = 'location for the model to be saved')
    parser.add_argument('--dpi', required = True, help = 'image quality in dpi, eg: 300')
